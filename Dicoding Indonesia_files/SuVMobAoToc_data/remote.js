...
C6(a);a.Bg=a.Vf.clone();b6(a.Bg,"t",a.D);a.Uk=0;a.uc=a.o.Zo(a.o.Ik()?b:null);0<a.Fp&&(a.En=new g.el((0,g.x)(a.FA,a,a.uc),a.Fp));a.A.ga(a.uc,"readystatechange",a.eM);var c=a.Yg?g.Zb(a.Yg):{};a.uh?(a.jo="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.uc.send(a.Bg,a.jo,a.uh,c)):(a.jo="GET",a.Ez&&!g.Id&&(c.Connection="close"),a.uc.send(a.Bg,a.jo,null,c));a.o.le(1)},$qa=function(a,b,c){for(var d=!0;!a.Lg&&a.Uk<c.length;){var e=Yqa(a,c);
...
if(null!=b)E6(5),b?(E6(11),N6(a.o,a,!1)):(E6(12),N6(a.o,a,!0));else if(a.wd=new A6(a,void 0,void 0,void 0),a.wd.Yg=a.Dp,b=a.o,b=M6(b,b.Ik()?a.Fj:null,a.Ep),E6(5),!g.Gd||g.kd(10))b6(b,"TYPE","xmlhttp"),B6(a.wd,b,!1,a.Fj,!1);else{b6(b,"TYPE","html");var c=a.wd;a=!!a.Fj;c.ii=3;c.Vf=a6(b.clone());bra(c,a)}},P6=function(a){g.rk.call(this);
...
if(3==a.o){var b=a.mk++,c=a.Xl.clone();$5(c,"SID",a.w);$5(c,"RID",b);$5(c,"TYPE","terminate");V6(a,c);b=new A6(a,a.w,b,void 0);b.ii=2;b.Vf=a6(c.clone());rqa(new Image,b.Vf.toString());b.Ni=(0,g.A)();C6(b)}tra(a)},vra=function(a){a.sC(1,0);
a.Xl=M6(a,null,a.Cp);W6(a)},sra=function(a){a.Zf&&(a.Zf.abort(),a.Zf=null);
...
var c=a.mk++,d=new A6(a,"",c,void 0);d.Yg=null;var e=Y6(a),f=a.Xl.clone();$5(f,"RID",c);$5(f,"CVER","1");V6(a,f);Xqa(d,f,e);a.qd=d;a.o=2}}else 3==a.o&&(b?xra(a,b):0==a.u.length||a.qd||xra(a))},xra=function(a,b){if(b)if(6<a.Mg){a.u=a.A.concat(a.u);
a.A.length=0;var c=a.mk-1;var d=Y6(a)}else c=b.G,d=b.uh;else c=a.mk++,d=Y6(a);var e=a.Xl.clone();$5(e,"SID",a.w);$5(e,"RID",c);$5(e,"AID",a.wi);V6(a,e);c=new A6(a,a.w,c,a.Vh+1);c.Yg=null;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.qd=c;Xqa(c,e,d)},V6=function(a,b){if(a.Oc){var c=a.Oc.Vu();
...
a.D++;a.kf=J6((0,g.x)(a.Jy,a),Ara(a,a.Ph));a.Ph++;return!0},N6=function(a,b,c){a.fo=c;
...
a.Oc&&(c=null);var d=(0,g.x)(a.PM,a);c||(c=new g.Fm("//www.google.com/images/cleardot.gif"),a6(c));dra(c.toString(),1E4,d)}else E6(2);Bra(a,b)},Bra=function(a,b){a.o=0;
a.Oc&&a.Oc.ku(b);tra(a);sra(a)},tra=function(a){a.o=0;
a.Be=-1;if(a.Oc)if(0==a.A.length&&0==a.u.length)a.Oc.So();else{g.db(a.A);var b=g.db(a.u);a.A.length=0;a.u.length=0;a.Oc.So(b)}},M6=function(a,b,c){var d=g.Nm(c);
...
secondTestResults:!a.o.fo,sessionId:a.o.w,arrayId:a.o.wi}},Gra=function(a,b){a.G=b||0;
...
a.w=g.wo((0,g.x)(a.Nr,a),0<a.A&&a.A<(0,g.A)()?2E4:1E4)},r7=function(a){i7("OnlineScreenService",a)},Vra=function(a){var b={};
...
if(b){if(a.info("onConnectedScreenId_: Received screenId: "+b),!a.w||a.w.id!=b){var c=(0,g.x)(a.yn,a),d=(0,g.x)(a.Ld,a);a.tv(b,c,d,5)}}else a.Ld(Error("Waiting for session status timed out."))},B7=function(a,b,c){y7.call(this,a,b,"DialSession");
...
this.yn(b)},a),(0,g.x)(function(b){this.o=g.Ea;
...
this.o=0;this.A=a;this.C=[];this.B=new Dra;this.w=this.u=null;this.H=(0,g.x)(this.rI,this);this.D=(0,g.x)(this.qk,this);this.G=(0,g.x)(this.qI,this);this.J=(0,g.x)(this.DI,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.Ls,this),rsa(this))):c=3;0!=c&&(b?this.Ls(c):g.wo((0,g.x)(function(){this.Ls(c)},this),0));
...
b==(d7(a.o)&&isNaN(a.B))?b&&(h8(a,1),l8(a,"getSubtitlesTrack")):b?(a.ov()&&a.Qa.reset(),h8(a,1),l8(a,"getNowPlaying"),xsa(a)):a.Th(1)},zsa=function(a,b){var c=b.params.videoId;
...
y6.prototype.parse=function(a){return g.v.JSON.parse(a,void 0)};z6.prototype.o=null;z6.prototype.getOptions=function(){var a;(a=this.o)||(a={},Uqa(this)&&(a[0]=!0,a[1]=!0),a=this.o=a);return a};var S8;g.Pa(Tqa,z6);S8=new Tqa;g.h=A6.prototype;g.h.Yg=null;g.h.me=!1;g.h.bj=null;g.h.Is=null;g.h.Ni=null;g.h.ii=null;g.h.Vf=null;g.h.Bg=null;g.h.uh=null;g.h.uc=null;g.h.Uk=0;g.h.se=null;g.h.jo=null;g.h.lg=null;g.h.Gj=-1;g.h.Ez=!0;g.h.Lg=!1;g.h.Fp=0;g.h.En=null;var Zqa={},D6={};g.h=A6.prototype;g.h.setTimeout=function(a){this.B=a};
g.h.eM=function(a){a=a.target;var b=this.En;b&&3==R6(a)?b.mm():this.FA(a)};
...
g.h.tL=function(a){this.Lg||(G6(this),this.me=a,this.o.wn(this),this.o.le(4))};
g.h.cancel=function(){this.Lg=!0;G6(this)};
g.h.CL=function(){this.bj=null;var a=(0,g.A)();0<=a-this.Is?(2!=this.ii&&this.o.le(3),G6(this),this.lg=2,E6(18),H6(this)):cra(this,this.Is-a)};
g.h.getLastError=function(){return this.lg};g.h=fra.prototype;g.h.Dp=null;g.h.wd=null;g.h.Fn=!1;g.h.Bv=null;g.h.Vl=null;g.h.hq=null;g.h.Ep=null;g.h.Zd=null;g.h.yf=-1;g.h.Fj=null;g.h.jj=null;g.h.connect=function(a){this.Ep=a;a=M6(this.o,null,this.Ep);E6(3);this.Bv=(0,g.A)();var b=this.o.G;null!=b?(this.Fj=b[0],(this.jj=b[1])?(this.Zd=1,gra(this)):(this.Zd=2,O6(this))):(b6(a,"MODE","init"),this.wd=new A6(this,void 0,void 0,void 0),this.wd.Yg=this.Dp,B6(this.wd,a,!1,null,!0),this.Zd=0)};
...
g.h.Ey=function(a,b){this.yf=a.Gj;if(0==this.Zd)if(b){try{var c=this.u.parse(b)}catch(d){c=this.o;c.Be=this.yf;$6(c,2);return}this.Fj=c[0];this.jj=c[1]}else c=this.o,c.Be=this.yf,$6(c,2);else if(2==this.Zd)if(this.Fn)E6(7),this.hq=(0,g.A)();else if("11111"==b){if(E6(6),this.Fn=!0,this.Vl=(0,g.A)(),c=this.Vl-this.Bv,!g.Gd||g.kd(10)||500>c)this.yf=200,this.wd.cancel(),E6(12),N6(this.o,this,!0)}else E6(8),this.Vl=this.hq=(0,g.A)(),this.Fn=!1};
g.h.wn=function(){this.yf=this.wd.Gj;if(this.wd.me)0==this.Zd?this.jj?(this.Zd=1,gra(this)):(this.Zd=2,O6(this)):2==this.Zd&&((!g.Gd||g.kd(10)?!this.Fn:200>this.hq-this.Vl)?(E6(11),N6(this.o,this,!1)):(E6(12),N6(this.o,this,!0)));else{0==this.Zd?E6(9):2==this.Zd&&E6(10);var a=this.o;this.wd.getLastError();a.Be=this.yf;$6(a,2)}};
...
this.aa&&(this.o.responseType=this.aa);"withCredentials"in this.o&&this.o.withCredentials!==this.V&&(this.o.withCredentials=this.V);try{nra(this),0<this.D&&(this.K=hra(this.o),d6(S6(this,"Will abort after "+this.D+"ms if incomplete, xhr2 "+this.K)),this.K?(this.o.timeout=this.D,this.o.ontimeout=(0,g.x)(this.Dv,this)):this.J=g.cl(this.Dv,this.D,this)),d6(S6(this,"Sending request")),this.G=!0,this.o.send(a),this.G=!1}catch(f){d6(S6(this,"Send error: "+f.message)),kra(this,f)}};
g.h.Dv=function(){"undefined"!=typeof g.z_&&this.o&&(this.A="Timed out after "+this.D+"ms, aborting",this.C=8,S6(this,this.A),this.dispatchEvent("timeout"),this.abort(8))};
...
g.h.Cv=function(){this.ha()||(this.da||this.G||this.B?mra(this):this.tK())};
...
g.h.getLastError=function(){return"string"===typeof this.A?this.A:String(this.A)};g.h=U6.prototype;g.h.uj=null;g.h.qd=null;g.h.Qb=null;g.h.Cp=null;g.h.Xl=null;g.h.Xt=null;g.h.nm=null;g.h.mk=0;g.h.JH=0;g.h.Oc=null;g.h.gg=null;g.h.kf=null;g.h.Qg=null;g.h.Zf=null;g.h.fo=null;g.h.wi=-1;g.h.hw=-1;g.h.Be=-1;g.h.Vh=0;g.h.Ph=0;g.h.Mg=8;var a7=new g.rk;g.Pa(pra,g.Uj);g.Pa(qra,g.Uj);g.Pa(rra,g.Uj);g.h=U6.prototype;g.h.connect=function(a,b,c,d,e){E6(0);this.Cp=b;this.uj=c||{};d&&void 0!==e&&(this.uj.OSID=d,this.uj.OAID=e);this.C?(J6((0,g.x)(this.ru,this,a),100),vra(this)):this.ru(a)};
g.h.ru=function(a){this.Zf=new fra(this);this.Zf.Dp=null;this.Zf.u=this.B;this.Zf.connect(a)};
g.h.Av=function(){return 0==this.o};
g.h.Ky=function(a){this.gg=null;yra(this,a)};
g.h.Jy=function(){this.kf=null;this.Qb=new A6(this,this.w,"rpc",this.D);this.Qb.Yg=null;this.Qb.Fp=0;var a=this.Xt.clone();$5(a,"RID","rpc");$5(a,"SID",this.w);$5(a,"CI",this.fo?"0":"1");$5(a,"AID",this.wi);V6(this,a);if(!g.Gd||g.kd(10))$5(a,"TYPE","xmlhttp"),B6(this.Qb,a,!0,this.nm,!1);else{$5(a,"TYPE","html");var b=this.Qb,c=!!this.nm;b.ii=3;b.Vf=a6(a.clone());bra(b,c)}};
g.h.Ey=function(a,b){if(0!=this.o&&(this.Qb==a||this.qd==a))if(this.Be=a.Gj,this.qd==a&&3==this.o)if(7<this.Mg){try{var c=this.B.parse(b)}catch(f){c=null}if(g.Ha(c)&&3==c.length)if(0==c[0])a:{if(!this.kf){if(this.Qb)if(this.Qb.Ni+3E3<this.qd.Ni)X6(this),this.Qb.cancel(),this.Qb=null;else break a;Z6(this);E6(19)}}else this.hw=c[1],0<this.hw-this.wi&&37500>c[2]&&this.fo&&0==this.Ph&&!this.Qg&&(this.Qg=J6((0,g.x)(this.lI,this),6E3));else $6(this,11)}else b!=Vsa.xO.o&&$6(this,11);else if(this.Qb==a&&
X6(this),!g.tb(b)){c=this.B.parse(b);g.Ha(c);for(var d=0;d<c.length;d++){var e=c[d];this.wi=e[0];e=e[1];2==this.o?"c"==e[0]?(this.w=e[1],this.nm=e[2],e=e[3],null!=e?this.Mg=e:this.Mg=6,this.o=3,this.Oc&&this.Oc.mu(),this.Xt=M6(this,this.Ik()?this.nm:null,this.Cp),zra(this)):"stop"==e[0]&&$6(this,7):3==this.o&&("stop"==e[0]?$6(this,7):"noop"!=e[0]&&this.Oc&&this.Oc.lu(e),this.Ph=0)}}};
g.h.lI=function(){null!=this.Qg&&(this.Qg=null,this.Qb.cancel(),this.Qb=null,Z6(this),E6(20))};
g.h.wn=function(a){if(this.Qb==a){X6(this);this.Qb=null;var b=2}else if(this.qd==a)this.qd=null,b=1;else return;this.Be=a.Gj;if(0!=this.o)if(a.me)1==b?(b=(0,g.A)()-a.Ni,a7.dispatchEvent(new qra(a7,a.uh?a.uh.length:0,b,this.Vh)),W6(this),this.A.length=0):zra(this);else{var c=a.getLastError(),d;if(!(d=3==c||7==c||0==c&&0<this.Be)){if(d=1==b)this.qd||this.gg||1==this.o||2<=this.Vh?d=!1:(this.gg=J6((0,g.x)(this.Ky,this,a),Ara(this,this.Vh)),this.Vh++,d=!0);d=!(d||2==b&&Z6(this))}if(d)switch(c){case 1:$6(this,
...
g.h=Cra.prototype;g.h.mu=function(){};
g.h.lu=function(){};
g.h.ku=function(){};
g.h.So=function(){};
...
g.h.mu=function(){this.u.reset();this.B=null;this.A=0;if(this.D.length){var a=this.D;this.D=[];for(var b=0,c=a.length;b<c;++b)wra(this.o,a[b])}this.R("handlerOpened")};
g.h.ku=function(a){var b=2==a&&401==this.o.Be;4==a||b||this.u.start();this.R("handlerError",a)};
g.h.So=function(a){if(!this.u.isActive())this.R("handlerClosed");else if(a)for(var b=0,c=a.length;b<c;++b){var d=a[b].map;d&&this.D.push(d)}};
...
g.h.lu=function(a){"S"==a[0]?this.H=a[1]:"gracefulReconnect"==a[0]?(this.u.start(),ura(this.o)):this.R("handlerMessage",new Era(a[0],a[1]))};
...
g.h.bo=function(a,b,c,d){var e=o7(this),f=this.get(a.id);f?(f.name!=b&&(f.name=b,q7(this,!1),e=!0),c(a)):d(Error("no such local screen."));e&&this.R("screenChange")};
...
g.h.jD=function(a){i7(this.D,"Requesting lounge tokens failed: "+a)};g.r(s7,g.P);g.h=s7.prototype;g.h.start=function(){var a=parseInt(g.jy("yt-remote-fast-check-period")||"0",10);(this.A=(0,g.A)()-144E5<a?0:a)?u7(this):(this.A=(0,g.A)()+3E5,g.iy("yt-remote-fast-check-period",this.A),this.Nr())};
...
g.h.Nr=function(){g.yo(this.w);this.w=NaN;this.u&&this.u.abort();var a=Vra(this);if(c6(a)){var b=f7(this.B,"/pairing/get_screen_availability");this.u=g7(this.B,b,{lounge_token:g.Pb(a).join(",")},(0,g.x)(this.PK,this,a),(0,g.x)(this.OK,this))}else t7(this,{}),u7(this)};
g.h.PK=function(a,b){this.u=null;var c=g.Pb(Vra(this));if(g.ob(c,g.Pb(a))){c=b.screens||[];for(var d={},e=0,f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;t7(this,d);u7(this)}else this.Jb("Changing Screen set during request."),this.Nr()};
...
v7.prototype.dispose=v7.prototype.dispose;g.Pa(y7,g.P);g.h=y7.prototype;g.h.yn=function(a){this.w=a;this.R("sessionScreen",this.w)};
...
g.h.Y=function(){this.Vr("");y7.xb.Y.call(this)};g.Pa(A7,y7);g.h=A7.prototype;g.h.Ur=function(a){if(this.o){if(this.o==a)return;z7(this,"Overriding cast sesison with new session object");this.o.removeUpdateListener(this.C);this.o.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.B)}this.o=a;this.o.addUpdateListener(this.C);this.o.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.B);bsa(this)};
...
g.h.Vr=g.Ea;g.h.Y=function(){this.info("disposeInternal");g.yo(this.A);this.A=0;this.o&&(this.o.removeUpdateListener(this.C),this.o.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.B));this.o=null;A7.xb.Y.call(this)};
...
g.h.tv=function(a,b,c,d){Yra(this.H,this.u.label,a,this.u.friendlyName,(0,g.x)(function(e){e?b(e):0<=d?(z7(this,"Screen "+a+" appears to be offline. "+d+" retries left."),g.wo((0,g.x)(this.tv,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
g.h.NA=function(){return this.o};
g.h.yN=function(a){this.ha()||a||(z7(this,"Cast session died."),this.Ld())};g.Pa(B7,y7);g.h=B7.prototype;g.h.Ur=function(a){this.A=a;this.A.addUpdateListener(this.K)};
...
g.h.Rp=function(a){this.J=l6();if(this.B){var b=new chrome.cast.DialLaunchResponse(!0,dsa(this));a(b);csa(this)}else this.D=(0,g.x)(function(){g.yo(this.C);this.D=g.Ea;this.C=NaN;var c=new chrome.cast.DialLaunchResponse(!0,dsa(this));a(c);csa(this)},this),this.C=g.wo((0,g.x)(function(){this.D()},this),100)};
g.h.MD=function(a,b,c){Yra(this.H,this.G.receiver.label,a,this.u.friendlyName,(0,g.x)(function(d){d&&d.token?(this.yn(d),b(new chrome.cast.DialLaunchResponse(!1))):this.Rp(b,c)},this),(0,g.x)(function(d){z7(this,"Failed to get DIAL screen: "+d);
this.Rp(b,c)},this))};g.Pa(C7,y7);C7.prototype.stop=function(){this.Ld()};
C7.prototype.Ur=g.Ea;C7.prototype.xi=function(){g.yo(this.o);this.o=NaN;var a=n6(this.H.Id(),this.u.label);a?this.yn(a):this.Ld(Error("No such screen"))};
...
E7("setConnectedScreenStatus: new active receiver: "+d.friendlyName);G7(this,new C7(this.u,d),!0)}this.o.Vr(b)}else E7("setConnectedScreenStatus: no screen.")};
...
c.receiverType!=chrome.cast.ReceiverType.CAST&&b.receiverType==chrome.cast.ReceiverType.CAST&&(E7("onSessionEstablished_: manual to cast session change "+b.friendlyName),g.yi(this.o),this.o=new A7(this.u,b),this.o.subscribe("sessionScreen",(0,g.x)(this.Hy,this,this.o)),this.o.xi(null));this.o.Ur(a)}}};
...
g.h.Ls=function(a){if((a!=this.o||2==a)&&3!=this.o&&0!=a){var b=this.o;this.o=a;this.R("proxyStateChange",b,a);if(1==a)for(;!this.B.isEmpty();)b=a=this.B,g.Ya(b.o)&&(b.o=b.u,b.o.reverse(),b.u=[]),a.o.pop().apply(this);else 3==a&&this.dispose()}};
...
g.h.bo=function(a,b,c,d){this.Qc.$_un(a,b,c,d)};
...
v7.prototype.$_st=v7.prototype.start;v7.prototype.$_gspc=v7.prototype.xN;v7.prototype.$_gsppc=v7.prototype.LA;v7.prototype.$_c=v7.prototype.contains;v7.prototype.$_g=v7.prototype.get;v7.prototype.$_a=v7.prototype.add;v7.prototype.$_un=v7.prototype.bo;v7.prototype.$_r=v7.prototype.remove;v7.prototype.$_gs=v7.prototype.Id;v7.prototype.$_gos=v7.prototype.KA;v7.prototype.$_s=v7.prototype.subscribe;v7.prototype.$_ubk=v7.prototype.If;var F8=null,E8=!1,n8=null,o8=null,D8=null,s8=[];g.r(G8,g.E);g.h=G8.prototype;
g.h.Y=function(){g.E.prototype.Y.call(this);this.A.stop();this.C.stop();this.K.stop();this.T();this.o.unsubscribe("proxyStateChange",this.Dy,this);this.o.unsubscribe("remotePlayerChange",this.tk,this);this.o.unsubscribe("remoteQueueChange",this.zn,this);this.o.unsubscribe("autoplayUpNext",this.dy,this);this.o.unsubscribe("previousNextChange",this.Ay,this);this.o.unsubscribe("nowAutoplaying",this.vy,this);this.o.unsubscribe("autoplayDismissed",this.by,this);this.o=this.B=null};
...
g.h.ZM=function(a){this.Xw("control_subtitles_set_track",g.Wb(a)?null:a)};
...
g.h.zn=function(){J8(this)||Rsa(this)};
g.h.VB=function(){this.o.zu()};
g.h.dy=function(){};
...
g.h.ck=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];this.loaded&&this.B.Xw.apply(this.B,[a].concat(g.ea(c)))};
