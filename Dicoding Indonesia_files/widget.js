...
var e=null,t=null,n=null,i=null,o=!1,s={},r={},d=["firstName","lastName","email","phone","phoneCountry","locale"]
return{getFlowId:function(){return n},setFlowId:function(e){n=e},getFlowVersionId:function(){return i},setFlowVersionId:function(e){i=e},getExternalId:function(){return e},setExternalId:function(t){e=t},getRestoreId:function(){return t},setRestoreId:function(e){t=e},setIdentifyByReferenceId:function(e){o=e},getIdentifyByReferenceId:function(){return o},getConfig:function(){return s},setConfig:function(e){s=e},getProperties:function(){return r},setProperties:function(e){e&&(d.forEach(function(t){a(this,this),e[t]&&(r[t]=e[t])}.bind(this)),e.meta&&this.setUserMeta(e.meta))},setFirstName:function(e){r.firstName=e},setLastName:function(e){r.lastName=e},setEmail:function(e){r.email=e},setPhone:function(e){r.phone=e},setPhoneCountry:function(e){r.phoneCountry=e},setUserMeta:function(e){if(r.meta=r.meta||{},e)for(var t in e)e.hasOwnProperty(t)&&(r.meta[t]=e[t])},setLocale:function(e){r.locale=e},reset:function(){e=null,t=null,s={},r={}},getJSON:function(){return{externalId:e,restoreId:t,customConfig:s,properties:r}}}}.bind(void 0)()
...
var e=null,t=null,n=null,s=null,r=null,d=null,u=!1,l=!1,f=null,c=!1,h=null,g=null,p=null,m=["get_user_uuid"]
return{getHost:function(){return r},getToken:function(){return t},getReferrer:function(){return n},getSiteId:function(){return s},getSettings:function(){return d},setSettings:function(e){u=!!((d=e).userAuthConfig&&d.userAuthConfig.jwtAuthEnabled&&d.userAuthConfig.strictModeEnabled),l=!(!d.userAuthConfig||!d.userAuthConfig.jwtAuthEnabled)},isJWTStrictMode:function(){return u},isJWTEnabled:function(){return l},getJWTAuthToken:function(){return f},setJWTAuthToken:function(e){f=e},isLoaded:function(){return c},loaded:function(e){c=e},loadingActions:function(){return m},init:function(e){t=e.token,n=e.referrer,r=e.host,s=e.siteId,u=!1,l=!1,f=e.jwtAuthToken,c=!1,h=e.flowId,g=e.flowVersionId,p=e.cspNonce},reset:function(){t=n=r=s=u=l=f=c=h=g=void 0},getJSON:function(){return{token:t,flowId:h,flowVersionId:g,referrer:n,host:r,siteId:s,jwtStrictMode:u,jwtEnabled:l,jwtAuthToken:f,loaded:c}},load:function(t,n,a){if(o.default.isSafariBrowser()&&p){var i=document.createElement("script")
i.nonce=p,i.textContent='window.location = "'.concat(t,'"'),e=a.contentWindow,a.contentDocument.body.appendChild(i)}else e=window.open(t,n)},postMessage:function(t){e&&e.postMessage(t,r)},dispatch:function(e,t){e&&t&&"function"==typeof e&&e(t)},unload:function(){this.postMessage({action:"push_subscribe_destroy"})},add:function(){var e=document,s=e.body,d=e.getElementById(a.default.frameDivId),u=e.createElement("IFRAME"),l=i.default.getConfig(),f=l&&l.cssNames,c=l&&l.widgetCanary
d&&"DIV"===d.tagName||(d=e.createElement("DIV"),s.appendChild(d)),o.default.setAttr(d,{id:a.default.frameDivId,class:f&&f.widget||""}),d.classList.add("fc_dn"),l&&l.headerProperty?("ltr"===l.headerProperty.direction&&d.classList.add("fc_l2r"),l.headerProperty.hideChatButton||d.classList.remove("fc_dn")):d.classList.remove("fc_dn"),o.default.setAttr(u,{id:a.default.frameId,name:a.default.frameId,title:"Chat",frameborder:"0",allowFullScreen:"true",webkitallowfullscreen:"true",mozallowfullscreen:"true"}),d.appendChild(u),this.load("".concat(r,"/widget/").concat(c?"canary/":"","?token=").concat(t,"&referrer=").concat(n),a.default.frameId,u)},remove:function(t){o.default.remove(t),e=null},setFrameSize:function(){var e=this.getSettings(),t=i.default.getConfig()
if(null===e)return""
...
break
case"frame_state_change":var C=document.getElementById(s.default.frameDivId),L=m&&m.data,O=L&&L.frameState,M=i.default.getSettings()&&i.default.getSettings().enabledFeatures
o.default.publish("frame:statechange",m),"initialized"===O&&(i.default.isJWTEnabled()&&i.default.isJWTStrictMode()&&C.classList.add("fc_dn"),this.loadWidget(),M&&-1!==M.indexOf("COBROWSING")&&g.default.init({host:i.default.getHost(),locale:d.default.getProperties().locale})),"loaded"===O&&i.default.loaded(!0),"authenticated"!==O&&"not_authenticated"!==O||i.default.isJWTEnabled()&&i.default.isJWTStrictMode()&&(m.success?C.classList.remove("fc_dn"):304!==m.status&&this.unloadWidget())
break
...
break
case"set_storage_item":if(a.default.storageAvailable){var N=m.data
N&&N.key&&N.value&&localStorage.setItem(N.key,JSON.stringify(N.value))}break
case"remove_storage_item":if(a.default.storageAvailable){var A=m.data
...
case"get_lsds_item":if(a.default.storageAvailable){var F=m.data,V=F&&F.key
V&&localStorage.getItem(V)}break
case"remove_lsds_item":if(a.default.storageAvailable){var W=m.data,q=W&&W.key
...
break
case"stack_max_height":document.getElementById(s.default.frameDivId).style.maxHeight=screen.height-250+"px",i.default.postMessage({action:"stacked_max_height",payload:{height:screen.height-250}})
break
